...
public class Game {
  public static void main(String[] args) {
    ...
    GameCharacter player = new GameCharacter("Asya", 2, 3, 'P', GameCharacterType.WIZARD);
    GameCharacter dummy = new GameCharacter("Dummy", 5, 6, 'D', GameCharacterType.RANGER);
    GameCharacter witch = new GameCharacter("Fluffy", 8, 9, '?', GameCharacterType.WARRIOR);
